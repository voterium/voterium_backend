...
use crate::counting::{
    count_votes_1, count_votes_2, count_votes_3, count_votes_4, count_votes_5, count_votes_6,
    count_votes_7, count_votes_8, count_votes_9,
};
...
pub async fn get_results(app_state: web::Data<AppState>, _req: HttpRequest) -> Result<HttpResponse, Error> {
    ...
    let mut vote_counts = count_votes_6(allowed_choices).map_err(|e| {
