...
use voterium_backend::counting::counting_funcs::{
    count_votes_01, count_votes_03, count_votes_04,
    count_votes_06, count_votes_08, count_votes_10,
    ...
    count_votes_21, count_votes_22, count_votes_23, count_votes_24, count_votes_25,
    count_votes_26, count_votes_27, count_votes_28, count_votes_29, count_votes_30,
    count_votes_31, count_votes_32, count_votes_33, count_votes_34

};

use voterium_backend::models::Choice;
use voterium_backend::counting::load_data;
...
fn benchmark_functions(c: &mut Criterion) {
    ...
    group.bench_function("count_votes_01", |b| {
        b.iter(|| count_votes_01(&data))
    });
    ...
    group.bench_function("count_votes_03", |b| {
        b.iter(|| count_votes_03(&data))
    });

    group.bench_function("count_votes_04", |b| {
        b.iter(|| count_votes_04(&data))
    });
    ...
    group.bench_function("count_votes_06", |b| {
        b.iter(|| count_votes_06(&data))
    });
    ...
    group.bench_function("count_votes_08", |b| {
        b.iter(|| count_votes_08(&data))
    });
